...
isaaclab -p scripts/reinforcement_learning/rsl_rl/train.py --headless --log_project_name angmom-loco --logger wandb --task Isaac-Velocity-Flat-G1-v0 --run_name test